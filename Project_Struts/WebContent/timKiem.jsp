							...
							<logic:greaterThan name="phienDauGiaForm" property="currentPage" value="1">
							 	<li class="page-item">
								    <logic:empty name="phienDauGiaForm" property="searchText">
					                	...
					                	<html:link action="/listSPTheoMa?page=${currentPage-1}" styleClass="page-link">
					                		Previous
					                	</html:link>
								    </logic:empty>
								    <logic:notEmpty name="phienDauGiaForm" property="searchText">
					                	...
					                	<html:link action="/listSPTheoMa?searchText=${searchText}&page=${currentPage-1}" styleClass="page-link">
					                		Previous
					                	</html:link>
								    </logic:notEmpty>
				                </li>
